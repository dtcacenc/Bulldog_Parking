						...
						<div class="container">
							...
							<div class="collapse navbar-collapse" id="navbarResponsive">
								<ul class="navbar-nav ml-auto">
									...
									<li class="nav-item">
										<a class="nav-link " href="carpool.php">
											<i>Carpool (alpha)</i>
										</a>
									</li>
									<li class="nav-item">
										...
										<div class="card">
												...
												<div class="e-profile">
													<div class="row">
														<div class="col-12 col-sm-auto mb-3">
															<div class="mx-auto" style="width: 140px;">
																<div class="d-flex justify-content-center align-items-center rounded" style="height: 140px; background-color: rgb(233, 236, 239);">
																	<img src="
																		<?php echo $_SESSION['picture'];?>" height=95% width=95%/>
														...
														<ul class="nav nav-tabs">
															...
															<li class="nav-item">
																<a href="address.php" class="active nav-link">Address</a>
															</li>
															<li class="nav-item">
														...
														<div class="tab-content pt-3">
															<div class="tab-pane active">
																<form action="addr_to_db.php" method="post">
																	...
																	<div class="form-group">
																		<textarea readonly class="form-control" id="autocomplete" name="autocomplete" rows="2" value="" ><?php echo $_SESSION['autocomplete_addr'];?></textarea>
																	</div>
																	<div class="form-check">
																		...
																		<div class="form-check">
																			<input type="checkbox"  class="form-check-input" id="agreeToTerms" required>
																				<label class="form-check-label" for="agreeToTerms">I Agree to the 
																					<a href="privacy_policy.html" target="_blank" rel="noopener noreferrer" >Terms and Conditions</a>
																				</label>
																			</div>
																			<div class="form-group">
																				<br>
											...
											<!-- /.container -->
											  ...
											  <div class="footer-copyright text-center py-3">
											  		<small>Autocomplete provided by 
											  		<a href="https://developer.here.com/" >HERE Location Technologies © 2020</a>
											  		</small>
											  </div>
										</body>
									</html>